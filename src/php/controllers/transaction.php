...
Class TransactionController{
    ...
    static function load_transaction($id){
        $_SESSION['transaction'] = Database::get_instance()->query('SELECT * FROM Transaction WHERE id ='. $id);
    }

    static function load_transactions(){
        $_SESSION['transactions'] = Database::get_instance()->query('SELECT * FROM Transaction');
    }
